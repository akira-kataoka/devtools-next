...
#### テスト対象モジュール (Phase 540-550 で整備、累計 134 テストケース)
...
| [js/design-docs.js](js/design-docs.js) | 設計書整形 (`fmtNum`, `fmtBytes`, `fmtTrunc`, `fmtPercent`, `fieldTypeJa`, `FIELD_TYPE_JA`, `xmlText`, `xmlAttr`, `md`, `esc`, `splitMd`) | 34 ケース |
