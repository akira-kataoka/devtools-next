...
const state = {
  ...
  // v3.327.0 Phase 417: popup.js state.apiVersion (line 20) と cross reference — 2 ファイルで同 default 値
  apiVersion: "62.0",
  lastRecords: null,
...
// v3.324.0 Phase 414: content.js SHARED_KEY (line 455) と同一キー (cross reference)。
//                     どちらのモードで履歴を更新しても chrome.storage.onChanged で 3 モード自動同期。
